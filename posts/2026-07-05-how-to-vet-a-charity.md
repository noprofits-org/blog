...
**The trap.** Compensation is the number outrage-farms love, precisely because the absolute figure is meaningless without the denominator. Running a large, complex nonprofit is a real executive job and pays like one. The actual red flags are relational: comp that's a large fraction of total budget, pay that keeps climbing while the mission shrinks, or generous compensation flowing to board members and their relatives (Schedule L covers related-party transactions — worth a glance if something feels off).
