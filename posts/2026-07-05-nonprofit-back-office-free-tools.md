...
- **Firebase** — Firestore, Auth, and Hosting on the free Spark plan; add pay-as-you-go Cloud Functions that stay free under generous monthly quotas. (If "serverless functions" is a fuzzy phrase, I wrote [a from-scratch tour of what they are](https://pvjohnston.com/posts/2026-06-20-what-are-cloud-functions.html).)
